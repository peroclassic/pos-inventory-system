...
<head>
  ...
  <title>NIS Transport | Customer</title>
        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">list of Registered Customers</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>NOK Name</th>
                    <th>NOK Phone</th>
                    <th>Times Travelled</th>
                    <th>Discounts Enjoyed</th>
...
$result = $db->prepare("SELECT * FROM customer");
            ...
            ?>
                  ...
                  <tr>
                    <td>CUST-00<?php echo $row['cust_id']; ?></td>
                    <td><?php echo $row['fname']; ?></td>
                    <td><?php echo $row['phone']; ?></td>
                    <td><?php echo $row['NOKname']; ?></td>
                    <td><?php echo $row['NOKphone']; ?></td>
                    <td><?php echo $row['times_travelled']; ?></td>
                    <td><?php echo $row['discounts_enjoyed']; ?></td>
                    <td><?php echo $row['datecreated']; ?></td>
                    <td><?php echo $row['dateupdated']; ?></td>
                    <td><?php echo $row['updated_by']; ?></td>
                    <td><?php echo $row['remark']; ?></td>
                    <td class="text-center"><a href="edit.php?cid=<?php echo $row['cust_id']; ?>" title="Edit"><button class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i></button></a> 
                      <form method="POST" action="">
                      <input type="text" name="c_id" value="<?php echo $row['cust_id']; ?>" hidden>
 ...
 $db = getDB();
$sta=$db->prepare("DELETE FROM customer
               WHERE cust_id = '$cid'");
$sta->execute();
if($sta){    
?>
