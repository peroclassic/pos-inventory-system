...
//include "connect.php";
   $db = getDB();
$result = $db->prepare("SELECT * FROM bus WHERE terminal_name='$terminalname' AND status!='Dispatched'");
$result->execute();
...
?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2-success" name="terminal_destination"  data-dropdown-css-class="select2-primary" required="" style="width: 100%;">
                    <option selected="selected" > </option>
  <?php
//include "connect.php";
   $db = getDB();
...
echo  $terminal_destination = "<option value='".$row['tname']."' >". $row['tname'] ."</option>";
}
?>
                  </select>
                </div>
