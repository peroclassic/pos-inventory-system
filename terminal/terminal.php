              ...
              <div class="card-body">
               ...
               <!-- <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="tname" class="form-control" data-inputmask-alias="terminalname" data-inputmask-inputformat="text" data-mask>
                  </div>-->
                  <!-- /.input group -->
                <!--</div>-->
                <!-- /.form group -->
                ...
                <!--<div class="form-group">
                        ...
                        <textarea class="form-control" name="taddress" rows="3" placeholder="Enter Address..."></textarea>
                      </div>-->
                <!-- /.form group -->
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="tcity" class="form-control" data-inputmask-alias="city" data-inputmask-inputformat="text" data-mask>
                  </div>-->
                  <!-- /.input group -->
  <!--              </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2-success" name="tmanager" data-dropdown-css-class="select2-primary" style="width: 100%;">
                    <option selected="selected"> </option>
                    <?php
//include "connect.php";
//   $db = getDB();
