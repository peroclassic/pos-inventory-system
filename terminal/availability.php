...
<head>
  ...
  <title>NIS Transport | Available</title>
        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">List of Available Vehicles for Usage</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $db = getDB();
$result = $db->prepare("SELECT * FROM availability WHERE terminal_name='$terminalname' OR terminal_destination='$terminalname' ORDER BY status ASC");
            ...
            ?>
                  <tr>
                    ...
                    <td><?php echo $row['departuredate'].':'.$row['departuretime']; ?></td>
                    <td><?php echo $row['amount']; ?></td>
                    <td><?php echo $row['driver_name']; ?></td>
                    <td><?php echo $row['terminal_name']; ?></td>
                    <td><?php echo $row['terminal_destination']; ?></td>
