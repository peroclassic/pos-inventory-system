...
<head>
  ...
  <title>NIS Transport | Edit</title>
  ...
  <aside class="main-sidebar sidebar-light-success elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Terminal Admin<br/>[<span style="color: red;"><?php echo $_SESSION['username'];?></span>]</a>
        </div>
      </div>
...
$db = getDB();
    ...
    $result = $db->prepare("SELECT * FROM admin WHERE admin_id = '$id'");
$result->execute();
...
<input type="text" name="id" value="<?php echo $row['admin_id'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask hidden>
                <!-- Username -->
...
<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2-success" name="terminal" data-dropdown-css-class="select2-primary" style="width: 100%;">
                    <option value="<?php echo $row['terminal'];?>" selected="selected"><?php echo $row['terminal'];?></option>
                    <?php
//include "connect.php";
   $db = getDB();
...
$db = getDB();
    ...
    $result = $db->prepare("SELECT * FROM driver WHERE d_id = '$did'");
$result->execute();
$stmp = $result->rowCount();
for($i=0; $row = $result->fetch(); $i++)
        
        {
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Edit Captain Details</h3>
              </div>
              <div class="card-body">
                <form action="update.php" method="POST">
                

<input type="text" name="did" value="<?php echo $row['d_id'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask hidden>
                <!-- Username -->
                <div class="form-group">
                  <label>Captain's Fullname:</label>

                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fa fa-user"></i></span>
                    </div>
                    <input type="text" name="fname" value="<?php echo $row['fname'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="phone" value="<?php echo $row['phone'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
                ...
                <!-- /.form group -->
                <div class="card-footer">
                  <button type="submit" name="updatecaptain" class="btn btn-success">Update Captain Details</button>
                </div>
              </form>
              </div>
              <!-- /.card-body -->
...
$db = getDB();
    ...
    $result = $db->prepare("SELECT * FROM customer WHERE cust_id = '$cid'");
$result->execute();
$stmp = $result->rowCount();
for($i=0; $row = $result->fetch(); $i++)
...
<input type="text" name="cid" value="<?php echo $row['cust_id'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask hidden>
                <!-- Username -->
                <div class="form-group">
            ...
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="phone" value="<?php echo $row['phone'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask readonly="">
                  </div>
                  <!-- /.input group -->
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="NOKname" value="<?php echo $row['NOKname'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="NOKphone" value="<?php echo $row['NOKphone'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
...
$db = getDB();
    ...
    $result = $db->prepare("SELECT * FROM admin WHERE username = '$_SESSION[username]'");
$result->execute();
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="route" value="<?php echo $row['terminal'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask readonly="">
                  </div>
                  <!-- /.input group -->
                </div>
