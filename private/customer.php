...
<head>
  ...
  <title>Demo Retail System | Customer</title>
...
$result = $db->prepare("SELECT * FROM customer");
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['regby']; ?></td>
                    <td><?php echo $row['updatedby']; ?></td>
                    <td class="text-center"><a href="edit.php?cid=<?php echo $row['cid']; ?>" title="Edit"><button class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i></button></a> 
