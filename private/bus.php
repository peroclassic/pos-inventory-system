...
$avseatsErr = ""; $terminal_nameErr = "";

$busno = $model = $avseats = $terminal_name = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (empty($_POST["terminal_name"])) {
               echo $terminal_nameErr = "<span style=\"color:red;\">Terminal Name is required</span>";
            }else {
               $terminal_name = test_input($_POST["terminal_name"]);
            }
  }
...
$remark= $_POST['remark'] = 'created by '.' '.$adminname;
  ...
  # code...
    ...
    $bid=$userClass->addBus($busno, $model, $avseats, $terminal_name, $status, $datecreated, $remark);
    if($bid)
    {
      
      ?>
      <script>
        alert('New Vehicle Added Successfully, Click OK to continue...');
...
$result = $db->prepare("SELECT * FROM bus");
            ...
            ?>
                  <tr>
                    ...
                    <td><?php echo $row['avseats']; ?></td>
                    <td><?php echo $row['terminal_name']; ?></td>
                    <td><?php echo $row['driver']; ?></td>
                    <td><?php echo $row['status']; ?></td>
                    <td><?php echo $row['updated_by']; ?></td>
                    <td><?php echo $row['remark']; ?></td>
                    <td class="text-center"><a href="edit.php?bid=<?php echo $row['bus_id']; ?>" title="Edit"><button class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i></button></a> 
                      <form method="POST" action="">
                      <input type="text" name="b_id" value="<?php echo $row['bus_id']; ?>" hidden>
 ...
 $db = getDB();
$sta=$db->prepare("DELETE FROM bus
               WHERE bus_id = '$bid'");
$sta->execute();
if($sta){    
?>
...
<?php 
          ...
          <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Add New Vehicle(Bus)</h3>
              </div>
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="busno" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="model" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" name="avseats" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask required="">
                  </div>
                  <!-- /.input group -->
                </div>
...
?>
                ...
                <div class="card-footer">
                  <button type="submit" name="create" class="btn btn-success">Add Bus</button>
                </div>
              </form>
              </div>
              <!-- /.card-body -->
