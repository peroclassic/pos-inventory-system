...
<head>
  ...
  <title>Demo Retail System | Out of Stock</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="outofstock.php" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">List of Products Out of Stock</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $db = getDB();
$result = $db->prepare("SELECT * FROM product WHERE pleft <=10 ORDER BY pleft ASC");
