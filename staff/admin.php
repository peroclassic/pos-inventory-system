...
$ban= $_POST['ban'] = 0;
  ...
  # code...
    ...
    if($uid)
    {
      $message= 'Dear '. $fname .'.CONGRATULATIONS you have just being registered on the NIS Transport platform as a Ticket Administrator with username: '. $username .' and password: '. $password .' - Your login link is www.brightelectricals.com . Please disregard this mail if you are not a staff of the organisation.';
...
<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2-success" name="position" data-dropdown-css-class="select2-primary" style="width: 100%;">
                    <option selected="selected" value='Sales Admin'>Sales Admin</option>
                    <?php
//include "connect.php";
   $db = getDB();
