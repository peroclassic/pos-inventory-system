...
<head>
  ...
  <title>Demo Retail System | Sales</title>
        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">List of Individual product sales Made</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $db = getDB();
$result = $db->prepare("SELECT * FROM sale ORDER BY datecreated DESC");
