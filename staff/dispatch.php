...
<head>
  ...
  <title>NIS Transport | Dispatch</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="dispatch.php" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">List of Dispatched Vehicles</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $db = getDB();
$result = $db->prepare("SELECT * FROM dispatch");
