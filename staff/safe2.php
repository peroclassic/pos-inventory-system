...
<body>
  <form method="POST" action="">
    ...
    <div class="ticket">
  <!--<div align="center">-->
    <a href="index.php"><img src="../dist/img/Logo2.jpeg" align="centered"></a>
    <p class="centered"><strong>Demo Retail System & LIGHTING HOUSE</strong><br> 
    KM 8 Benin Sapele Rd, B/C<br>
    <strong>09160372853, 09156328170</strong><br>
...
<div align="center">
  ...
  <table width="100%" border="0">
    <thead>
      ...
      <th class="amt"><div align="center">Amount</div></th>
    </tr>
    </thead>
    <tbody>
      <?php
