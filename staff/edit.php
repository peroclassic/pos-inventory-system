  ...
  <aside class="main-sidebar sidebar-light-success elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Staff Admin<br/>[<span style="color: red;"><?php echo $_SESSION['username'];?></span>]</a>
        </div>
      </div>
...
<input type="text" name="pid" value="<?php echo $row['pid'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text" data-mask hidden>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <textarea name="pdesc" value="<?php echo $row['pdesc'];?>" class="form-control" data-inputmask-alias="username" data-inputmask-inputformat="text">  
                    </textarea>
                  </div>
                  <!-- /.input group -->
                </div>
